...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/arpeggio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9516&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/arpeggio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `arpeggio` can be installed with:

```
conda install arpeggio
```

It is possible to list all of the versions of `arpeggio` available on your platform with:
